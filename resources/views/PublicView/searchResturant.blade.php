...
@section('findRestaurant')
    id="active"
@endsection

@section('content')
    <form action="{{route('search_page_keyword_public')}}" method="post">
        @csrf
        <div class="row">
       ...
       <table class="table  table-hover">
          ...
          <tbody>
              ...
              <tr>
                  ...
                  <td>{{$page->area}}</td>
                  <td class="ui-helper-center">  <a href="{{route('viewfoodpage_public', ['page_id' => $page->id])}}" class="card-link btn btn-outline-secondary btn-sm">View Page</a> </td>
              </tr>
              @endforeach
          </tbody>
      </table>
