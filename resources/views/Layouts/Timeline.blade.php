            ...
            <div class="row">
                <div class="col-lg-2">
                    ...
                    <div class="list-group">
                        <a href="{{route('timeline')}}" class="list-group-item ">
                            <i class="fa fa-fw fa-home"></i>
                            Timeline
                        </a>
                        <a href="{{route('searchpeople')}}" class="list-group-item ">
                            <i class="fa fa-fw fa-search"></i>
                            Search People
                        </a>
                        <a href="{{route('searchfoodpage')}}" class="list-group-item ">
                            <i class="fa fa-fw fa-search"></i>
                            Search Food
                        </a>
                        <a href="{{route('searchRestaurant')}}" class="list-group-item">
                            <i class="fa fa-fw fa-cutlery"></i>
                            Search Restaurant
                        </a>


                        <a href="/followers" class="list-group-item ">
